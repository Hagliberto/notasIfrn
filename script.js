...
function reset() {
    ...
    if (notasAtividadesVazias && notaProvaFinalVazia) {
      alert("Caso queira recalcular, insira pelo menos uma nota válida entre 0 e 10.");
    }
  
    var elementsToClear = ["media-atividades", "parcial", "nota-prova-final-necessaria", "final"];
